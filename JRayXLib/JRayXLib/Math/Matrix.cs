...
namespace JRayXLib.Math
{
     ...
     */
        public static void CreateRotationMatrix(Vect3 axis, double angleRad, Matrix4 erg)
        {
            ...
            double v1xICosA = axis[0] * icosa;

            data[0, 0] = cosa + axis[0] * v1xICosA;
            data[0, 1] = axis[1] * v1xICosA - axis[2] * sina;
            data[0, 2] = axis[2] * v1xICosA + axis[1] * sina;
            data[0, 3] = 0;
            data[1, 0] = axis[1] * v1xICosA + axis[2] * sina;
            data[1, 1] = cosa + axis[1] * axis[1] * icosa;
            data[1, 2] = axis[1] * axis[2] * icosa - axis[0] * sina;
            data[1, 3] = 0;
            data[2, 0] = axis[2] * v1xICosA - axis[1] * sina;
            data[2, 1] = axis[2] * axis[1] * icosa + axis[0] * sina;
            data[2, 2] = cosa + axis[2] * axis[2] * icosa;
            data[2, 3] = 0;
            data[3, 0] = 0;
            data[3, 1] = 0;
            data[3, 2] = 0;
